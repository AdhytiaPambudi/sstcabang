...
public function getkartustokdaily($datetrans = NULL, $produk = NULL)
    ...
    public function generatestok($params = NULL)
    {
      ...
      foreach ($params->Kode_Produk as $key => $value) 
      {
        ...
        $saldobaik = ($s_awalbaik + $bpb + $relokasi_terima + $qty_korbaik_plus + $returjual + $DORetur)  - ($usulanretursupplier  + $usulanrelokasi_kirim + $qty_korbaik_min + $DOkirim + $usulanrelokasi_kirim + $relokasi_kirim) + $qty_usulankoreksibaik + $tolakanretursupplier;
        $saldorelokasi = $s_awalrelokasi - $usulanrelokasi_kirim + $qty_usulankoreksiRelokasi;
        $saldoretursupp = ($s_awalretursup + $usulanretursupplier ) - $returbeli - $qty_kor_retsupplier_min + $qty_usulankoreksisupplier - $tolakanretursupplier;
        $saldokoreksi = $s_awalkoreksi + $qty_allusulankoreksi;
        ...
        // log_message("error",print_r("Produk : " . $params->Kode_Produk[$key],true));
        // log_message("error",print_r("SaldoAwal : " . $saldoawal,true));
        // log_message("error",print_r("SaldoAwal Baik : " . $s_awalbaik,true));
        // log_message("error",print_r("SaldoAwal Retur : " . $s_awalretursup,true));
        // log_message("error",print_r("SaldoAwal Relokasi : " . $s_awalrelokasi,true));
        // log_message("error",print_r("SaldoAwal Relo Out : " . $s_awalrelokasiout,true));
        // log_message("error",print_r("SaldoAwal Koreksi : " . $s_awalkoreksi,true));
        // log_message("error",print_r("Saldo Akhir : ".$totalsaldo,true));
        // log_message("error",print_r("Usulan Retur Supplier " . $usulanretursupplier,true));
        // log_message("error",print_r("Retur Supplier : ". $retursupplier,true));
        // log_message("error",print_r("BPB : " . $bpb,true));
        // log_message("error",print_r("Relokasi Terima : " . $relokasi_terima,true));
        // log_message("error",print_r("Koreksi Plus : ". $koreksiplus,true));
        // log_message("error",print_r("Retur Jual : : ".$returjual,true));
        // log_message("error",print_r("DO Kirim : " . $DOkirim,true));
        // log_message("error",print_r("DO Retur : " . $DORetur,true));
        // log_message("error",print_r("Usulan Relokasi Kirim : " .$usulanrelokasi_kirim,true));
        // log_message("error",print_r("Relokasi Kirim : " .$relokasi_kirim,true));
        // log_message("error",print_r("Koreksi Min : ". $koreksimin,true));
        // log_message("error",print_r("Usulan Koreksi : ". $qty_allusulankoreksi,true));
        // log_message("error",print_r("Saldo Baik  : " .$saldobaik,true));
        // log_message("error",print_r("Saldo Relokasi  : " .$saldorelokasi,true));
        // log_message("error",print_r("Saldo Retur Supplier  : " .$saldoretursupp,true));
        // log_message("error",print_r("Saldo Koreksi  : " .$saldokoreksi,true));
        // log_message("error",print_r("Saldo Relokasi Out  : " .$s_awalrelokasiout,true));
      }
      $valid =true;
      return $valid;
    }
    ...
    public function generatestokbulanan($params = NULL,$first_date= NULL,$end_date= NULL,$getmonth= NULL,$getyear= NULL)
    {
      ...
      foreach ($params->Kode_Produk as $key => $value) 
      {
        ...
        $qty_usulankoreksiRelokasi = $query->qty_usulankoreksiRelokasi;
        $qty_usulankoreksisupplier = $query->qty_usulankoreksisupplier;
        $saldobaik = ($s_awalbaik + $bpb + $relokasi_terima + $qty_korbaik_plus + $returjual + $DORetur)  - ($usulanretursupplier  + $usulanrelokasi_kirim + $qty_korbaik_min + $DOkirim + $usulanrelokasi_kirim + $relokasi_kirim) + $qty_usulankoreksibaik + $tolakanretur;
        $saldorelokasi = $s_awalrelokasi - $usulanrelokasi_kirim + $qty_usulankoreksiRelokasi;
        $saldoretursupp = ($s_awalretursup + $usulanretursupplier ) - $returbeli - $qty_kor_retsupplier_min + $qty_usulankoreksisupplier - $tolakanretur;
        $saldokoreksi = $s_awalkoreksi + $qty_allusulankoreksi;
                ...
                if ($j["cek"] == "Beda") {
                  ...
                  for ($i=$getmonth; $i <= date('m'); $i++) { 
                    ...
                    if (strlen($i) == 1) {
                      $valid = $this->db->query("UPDATE trs_invdet
                                 set
                                     SAwa"."0".$i." = '".$j["seharusnya"]."',
                                     VAwa"."0".$i." = '".$j["seharusnya"]."' * UnitCOGS
                                 where KodeProduk = '".$Kode."' and 
                                      Gudang = '".$gudang."' and 
                                      BatchNo ='".$j["BatchNo"]."' and 
    ...
    function reproses_kartustok($gudang = NULL,$first_date = NULL,$end_date = NULL,$Kode = NULL,$getmonth = NULL,$getyear = NULL){
      ...
      $saldo_awal = 0;
        ...
        if ($gudang == "Baik") {
              $valid = $this->reproses_kartustok_baik($gudang,$first_date,$end_date,$Kode,$getmonth,$getyear,$saldo_awal);
        }elseif ($gudang == "Koreksi") {
              $valid = $this->reproses_kartustok_koreksi($gudang,$first_date,$end_date,$Kode,$getmonth,$getyear,$saldo_awal);
        }elseif ($gudang == "Lain-lain") {
              $valid = $this->reproses_kartustok_lain($gudang,$first_date,$end_date,$Kode,$getmonth,$getyear,$saldo_awal);
        }elseif ($gudang == "Relokasi") {
              $valid = $this->reproses_kartustok_relokasi($gudang,$first_date,$end_date,$Kode,$getmonth,$getyear,$saldo_awal);
        }elseif ($gudang == "Retur Supplier") {
              $valid = $this->reproses_kartustok_retur($gudang,$first_date,$end_date,$Kode,$getmonth,$getyear,$saldo_awal);
        }else{
              $valid = ["status" =>false,"message"=>" Tidak ada transaksi di gudang ini"];
        }
    ...
    function reproses_kartustok_baik($gudang,$first_date,$end_date,$Kode,$getmonth,$getyear,$saldo_awal){
      $valid = true;
      ...
      if($cek_sawal->num_rows() > 0 ){
        ...
        $data = $this->db->query("SELECT
                          ...
                          FROM
                            ...
                            ) z GROUP BY BatchNo ,NoDoc,ExpDate 1");
          $sum_qty = 0;
                  ...
                  if ($batch_detail->num_rows() > 0) {
                      ...
                      foreach ($batch_detail->result_array() as $kk) {
                        if ($kk['SAwa'.$getmonth] != "0"  ) {
                          ...
                          // echo $r->BatchNo." , ".$r->NoDoc." , ".$kk['SAwa'.$getmonth]." , ".($r->qty_in - $r->qty_out)." , ".$stok_unit." a<br>";
                        }else{
                          // echo $r->BatchNo." , ".$r->NoDoc." , ".$kk['SAwa'.$getmonth]." , ".($r->qty_in - $r->qty_out)." b<br>";
                          ...
                          if ($stok_unit < 0) {
                            ...
                            /*$valid = false;
                            $message = "Stok tidak boleh minus setelah reproses , Produk ".$Kode ." , Batch = ". $r->BatchNo ." , NoDokumen = ". $r->NoDoc ." , ExpDate = ". $r->ExpDate ." , stok = ".$stok_unit;
    ...
    function reproses_kartustok_koreksi($gudang,$first_date,$end_date,$Kode,$getmonth,$getyear,$saldo_awal){
    ...
    function reproses_kartustok_lain($gudang,$first_date,$end_date,$Kode,$getmonth,$getyear,$saldo_awal){
        $data = $this->db->query("SELECT
    ...
    function reproses_kartustok_relokasi($gudang,$first_date,$end_date,$Kode,$getmonth,$getyear,$saldo_awal){
      $valid = true;
    ...
    function reproses_kartustok_retur($gudang,$first_date,$end_date,$Kode,$getmonth,$getyear,$saldo_awal){
    ...
    function generate_addjustment_by_reproses($gudang,$Kode,$stok_unit,$getyear,$getmonth,$selisih_detail,$tipe){
      ...
      if ($get_all_detail->num_rows() > 0) {
        ...
        if ($tipe!= "") {
          $this->db->set("tanggal", date('Y-m-t', strtotime(date("Y-m-d"))));
        }else{
          $this->db->set("tanggal", date("Y-m-d"));
        }
        ...
        if ($tipe!= "") {
          for ($i=$getmonth; $i < date('m'); $i++) { 
            if (strlen($i) == 1) {
              $this->db->set("SAwal"."0".$i, ($get_sum->UnitStok + $stok_unit));
              $this->db->set("VAwal"."0".$i, $valuestok_baik);
            }else{
              $this->db->set("SAwal".$i, ($get_sum->UnitStok + $stok_unit));
              $this->db->set("VAwal".$i, $valuestok_baik);
            }
          }
    ...
    function reproses_stokdetail($status=NULL,$first_date=NULL,$end_date=NULL,$Kode=NULL,$getmonth=NULL,$getyear=NULL,$saldoakhir=NULL,$stokdetail=NULL){
      ...
      if($saldoakhir == 0){
        ...
        if($sbaik == 0){
          ...
          $valid = $this->reproses_kartustok_baik("Baik",$first_date,$end_date,$Kode,$getmonth,$getyear,$saldo_awal);
        ...
        if($sKoreksi == 0){
          ...
          $valid = $this->reproses_kartustok_koreksi("Koreksi",$first_date,$end_date,$Kode,$getmonth,$getyear,$saldo_awal);
        }
        ...
        if($slain == 0){
          ...
          $valid = $this->reproses_kartustok_lain("Lain-lain",$first_date,$end_date,$Kode,$getmonth,$getyear,$saldo_awal);
        }
        ...
        if($sRelokasi == 0){
          ...
          $valid = $this->reproses_kartustok_relokasi("Relokasi",$first_date,$end_date,$Kode,$getmonth,$getyear,$saldo_awal);
        }
        ...
        if($ssupp == 0){
          ...
          $valid = $this->reproses_kartustok_retur("Retur Supplier",$first_date,$end_date,$Kode,$getmonth,$getyear,$saldo_awal);
        }
      }
     return $valid;   
    }
    public function getSAwalstokdetail($getmonth=null,$getyear=null){
        $query = $this->db->query("
                            SELECT a.`Cabang`,
                                   a.`Tahun`,
                                   (case '".$getmonth."' 
