...
class Usulan_Pelanggan extends CI_Controller {
    ...
    {   
        ...
        {   
            ...
            $this->content['kotas'] = $this->Model_usulan_pelanggan->datakota();
            $this->content['tipe_pelanggans'] = $this->Model_usulan_pelanggan->datatipepelanggan();
            $this->twig->display('pembelian/editpelanggan.html', $this->content);
    ...
    public function getalldataPelanggan($kode = NULL)
    {
        if ($this->logged) 
        {
            $data = $this->Model_usulan_pelanggan->getalldataPelanggan($kode);
    ...
    public function saveeditpelanggan()
    {          
        if ($this->logged) 
        {   
            $params = (object)$this->input->post();
            $valid = $this->Model_usulan_pelanggan->saveeditpelanggan($params);
    ...
    public function addDataPelanggan()
    {
        ...
        {   
            ...
            $data = array(
                ...
                'Asst_Apoteker' => $this->input->post('nama_asisten_apoteker'),
                'TTK' => $this->input->post('no_ijin_asisten_apoteker'),
                'EDTTK' => $this->input->post('ed_ttk'),
                'Status_Usulan' => "Usulan",
                'No_KTP' => $this->input->post('no_ktp'),
                'No_Ijin_Usaha' => $this->input->post('no_ijin_usaha'),
