...
class CetakTransaksi extends CI_Controller {
	...
	function print_do_penjualan_mpdf(){
		...
		foreach ($data['header'] as $key => $headers) {
			log_message('error',print_r($headers->NoDO,true));
					...
					<tr>
			            <td width="450" valign="top">
			                ...
			                .$headers->Alamat.'<br>'
            				 .$headers->Bank_Acc.
			            '</td>
			            <td rowspan="2" valign="top" width="170" style="line-height: 15px;">
			               	'.$headers->NoDO.'<br>
			            ...
			            <td rowspan="2" valign="top" width="160" style="line-height: 13px; padding-top:5px;">
			            		<!-- <img src="'.getcwd()."/assets/logo/faktur.png".'" height="40" width="130" style="text-align:center; margin-bottom:5px;"/> -->
			            		<h2>XXXXXXXXXXX</h2>
			            	<br>
			            	<p style="text-align:center; font-size:20px;">FAKTUR</p>
			            	<br>
			            	<strong>No Faktur :</strong> '.$headers->NoDO.'<br><br>
		                    No. Acu : '.$headers->Acu.'<br>
		                    Salesman : '.$headers->Salesman.'
			            </td>
			        </tr>
			        <tr>
			            <td valign="top" style="padding-left:72px;">'.
