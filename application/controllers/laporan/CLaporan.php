        ...
        if ($this->logged) 
        {
            ...
            */
            ...
            foreach ($query as $baris) {
                ...
                $row[] = (!empty($baris->No_KTP) ? $baris->No_KTP : "");
