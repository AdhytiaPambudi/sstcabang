  ...
  //   } 
    ...
    public function reproses_stokdetail()
    {
		...
		{			
			...
			// $sawal = $this->Model_inventori->saldoawal($Kode,$getmonth,$getyear);
			$list = $this->Model_inventori->reproses_stokdetail($status,$first_date,$end_date,$Kode,$getmonth,$getyear,$saldoakhir,$stokdetail);
	...
	public function getSAwalstokdetail()
    {
    	if ($this->logged) 
		{
			...
			$list = $this->Model_inventori->getSAwalstokdetail($getmonth,$getyear);
			$data = array();
			$x = 0;
			foreach ($list as $key) {
				$x++;
