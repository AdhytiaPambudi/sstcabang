...
<body>
    <?php $zzz = ($_POST["var1"]); ?>
        <?php
            $data_detail  = json_decode($zzz, true);
            // print_r($data_detail);
            // return;
            $t_qty = 0;
            $t_potongan = 0;
    ...
    <table border="0" cellspacing="0" style="font-family: sans-serif; margin-left: 0px;">
        <tr>
            ...
            <td valign="top" align="center">
                <?php 
                    echo "<H4>".$data_detail[0]['TipeDokumen']."</H4>";
    ...
    <table cellspacing="0" class="report-container report-container" border="0">
        <thead class="report-header">
            <tr class="detail atas" align="center">
                ...
                <td rowspan="2" width="80" style="border:solid 1px;">POT.</td>
            ...
            <?php if($detail['QtyFaktur'] + $detail['BonusFaktur'] > 0) {
               ...
               if(strlen($detail['NamaProduk']) > 26 || strlen($detail['UOM']) > 5){
                ...
                <tr v-for = "(index,datas) in data_detail" class="detail-item">
                    ...
                    <td valign="top" style='padding-right:2px;' align='center'><?php echo ($detail['QtyFaktur'] + $detail['BonusFaktur']) ?></td>
        ...
        <tfoot class="report-footer">
            <tr class="detail atasz" style="font-size: 11px; border-top: solid 1px;" >
                <td class='awal' colspan="8" valign="top">Jumlah</td>
            ...
            <tr class="detail atas">
                <td style='padding-left:5px; text-transform: capitalize;' colspan="8" rowspan='2' valign="top" class="awal">Terbilang : <br> <span id ="terbilang_value"></span><?php echo terbilang(round($detail['Total'])).' rupiah' ?></td>
            ...
            <tr class="detail">
                <td colspan="2" rowspan="4" class="awal" valign="top">
                    ...
                    <div style="float: left; width: 170px; margin-top: 5px;">
                        <?php 
                            echo '<img src="assets/qrcode.php?text='.$data_detail[0]['NoFaktur'].'" style="border:solid 1px;" height="50" width="50" />';
                            echo "<br>";
            ...
            <tr class="detail">
                ...
                <td align='right' v-html='Total | currencyDisplay' style='padding-right:2px; font-weight: bold;'><?php echo number_format($detail['Total']) ?></td>
            </tr>
            <tr class="detail">
                <td colspan="3" height="20">Dasar Pengenaan Pajak</td>
            </tr>
            <tr>
