...
<body>
    <?php $data_detail = ($_POST["var1"]); ?>
        <?php
            ...
            // $baris_kosong2 = 6;
            $jumlah_baris_data = 0;
            $jml_baris_standar_halaman1 = 15;
            $jml_baris_standar_halaman2 = 48;
    ...
    <table cellspacing="0" class="report-container report-container" border="0">
        <thead class="report-header">
            <tr class="detail atas" align="center">
                ...
                <td rowspan="2" width="70" style="border:solid 1px;">ID</td>
        ...
        <?php foreach ($data_detail as $key => $detail) { ?>
            <?php if($detail['QtyFaktur'] + $detail['BonusFaktur'] <> 0) {
                ...
                <tr v-for = "(index,datas) in data_detail" class="detail-item">
                    ...
                    <td valign="top" v-html='datas.KodeProduk' class='awal' style='padding-left:5px; font-size:8px;'><?php echo $detail['KodeProduk'] ?></td>
                    <td style='padding-left:2px; font-size: 9px;' valign="top">
                    ...
                    <td valign="top"  style='padding-right:2px;' align='right'><?php echo $detail['QtyFaktur'] ?></td>
                    ...
                    <td valign="top"  style='padding-left:2px;font-size:8px;'><?php echo date_format(date_create($detail['ExpDate']),"Y-m-d") ?></td>
                    ...
                    <td <?php echo $detail['DiscCab']+$detail['DiscPrins1']+$detail['DiscPrins2'] ?>
                    </td>
                    ...
                    for($i=$jumlah_baris_data; $i < $jml_baris_standar_halaman2; $i++ ){ ?>
                        ...
                        <?php }else{ ?>
                            <tr>
                                ...
                                <td style="border-left: solid 1px; padding: 0px 2px 0px 2px;">&nbsp;</td>
                                <td style="border-left: solid 1px; border-right: solid 1px; padding: 0px 2px 0px 2px;">&nbsp;</td>
                                <td colspan="12" style="border-left: solid 1px; border-right: solid 1px; padding: 0px 2px 0px 2px;">&nbsp;</td>
                            </tr>
                        <?php } ?>
        ...
        <tfoot class="report-footer">
            <tr class="detail atasz" style="font-size: 11px; border-top: solid 1px;" >
                <td class='awal' colspan="2" valign="top">Jumlah</td>
            ...
            <tr class="detail atas">
                <td style='padding-left:5px; text-transform: capitalize;' colspan="9" rowspan='2' valign="top" class="awal">Terbilang : <br> <span id ="terbilang_value"></span><?php echo terbilang($detail['Total']).' rupiah' ?></td>
            ...
            <!-- --------------------------------------------------------- -->
            <tr class="detail">
                <td colspan="2" rowspan="4" class="awal">
                    <div id="qcTarget"></div>
                    <img id="qrImage" src="" style="margin:2px;">
                    <?php 
                        echo '<img src="assets/qrcode.php?text='.$data_detail[0]['NoPajak'].'" style="border:solid 1px;" />';
                        echo $data_detail[0]['NoFaktur'];
                    ?>
                </td>
                <td colspan="4" rowspan="4" align="center">Penerima, <br><br><br><br><br></td>
                <td colspan="3" rowspan="4" align="center">Hormat Kami,<br>
            ...
            <tr>
                <td colspan="13" style="font-size: 8px;">
