...
<body>
    ...
    <table  border="0" cellspacing="0" >
        <tr>
            ...
            <td align="right" valign="top" width="280" nowrap>
                    Kepada Yth : <br>
                    <?php 
                        if($data_detail[0]['total_supplier'] > 1){
                            echo $data_detail[0]['Supplier_2'];
                        }else{
                            echo $data_detail[0]['Supplier'];
                        }
                    ?>
            </td>
        </tr>
    ...
    <table style="font-size: 11px; line-height: 12px;">
        ...
        <tr>
            <td>Akhir Kontrak</td>
            <td>:</td>
            <td><?php echo $data_detail[0]['Akhir_Kontrak'] ?></td>
        </tr>
    </table>
    <table cellspacing="0">
    <thead>
    ...
    <tbody class="report-body">
        ...
        <tr class="detail-item" style="font-size: 11px; page-break-after: always;" >
            ...
            <td align="center"><?php echo $datas['Qty_PO'] ?></td>
    ...
    <?php if($data_detail[0]['total_supplier'] > 1){ ?>
        <div align="right">Copy of Surat Pesanan <?php echo $data_detail[0]['Supplier_2'] ?></div>
    	<table  border="0" cellspacing="0" >
        <tr>
            <td height="70px" width="280" valign="top" style="line-height: 12px;" nowrap>
                <img src="assets/logo/1489135837049.jpg" width="50" height="65" style="float:left;">
